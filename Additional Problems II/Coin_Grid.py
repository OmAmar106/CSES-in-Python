...
#2D-SegmentTree: seg2d, Rollback/Par DSU: rbdsu, Graphflow(flow,max_match): graphflow, DynamicConnectivity: odc
#Treap: treap
...
def solve():
    ...
    ans,ans1 = hk.vertex_cover()

    for i in ans:
        print(1,i+1)
    for j in ans1:
        print(2,j+1)
    # (0,2) and (1,0) ko remove krunga
    # but i expected all elements in the column to boom
